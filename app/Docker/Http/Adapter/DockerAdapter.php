...
namespace App\Docker\Http\Adapter;
...
class DockerAdapter implements AdapterInterface
{
    ...
    public function __construct(MessageFactoryInterface $messageFactory, $entrypoint, $context = null, $useTls = null)
    {
        ...
        stream_filter_register('chunk', '\App\Docker\Http\Stream\Filter\Chunk');
        stream_filter_register('event', '\App\Docker\Http\Stream\Filter\Event');
    }
